...
<div id="addTaskModal" class="modal">
    <div class="modal-content">
        ...
        <form id="addTaskForm" method="POST" action="/store" class="modal-form">
            <label>Task ID:</label>
...
<div id="editTaskModal" class="modal">
    <div class="modal-content">
        ...
        <form id="editTaskForm" method="POST" action="/update" class="modal-form">
